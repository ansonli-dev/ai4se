...
英文版：[../../practice/02-implementation-playbook.md](../../practice/02-implementation-playbook.md)
...
原英文文档中的 RACI 表定义了 交付负责人、Architect、QA 负责人、安全负责人、团队负责人、AI Champion、模块负责人 和 供应商负责人 在治理政策、模板、Story Spec、架构决策、测试策略、安全例外、核心模块变更和周度指标复盘中的 R/A/C 关系。
