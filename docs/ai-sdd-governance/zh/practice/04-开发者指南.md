...
- Tier A：Story card、轻量 SDD note、必要测试证据、AI usage declaration、普通 评审。
- Tier B：Story card、SDD Story 规格、必要 技术规格、实现计划、测试规格、相关契约、验证证据。
- Tier C：完整 SDD Story 规格、技术规格、必要 ADR、完整测试和契约、Owner approval、完整质量门禁和验证证据。
