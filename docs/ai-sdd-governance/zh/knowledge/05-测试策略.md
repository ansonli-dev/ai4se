...
英文版：[../../knowledge/05-testing-strategy.md](../../knowledge/05-testing-strategy.md)

## 目的

本文总结 Martin Fowler 测试材料中的关键思想，并将其适配到 AI-assisted development、SDD、Superpowers 和轻量 Harness 工程。
